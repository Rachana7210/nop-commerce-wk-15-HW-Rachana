...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException{
        ...
        //Fill ALl Fields
        checkOutPage.enterBillingFirstName("Rashi");
        checkOutPage.enterBillingLastName("Vegad");
        checkOutPage.enterBillingEmailAddress("rashi@example.com");
        checkOutPage.selectCountryFromDropDown("233");
        checkOutPage.selectStateFromDropDown("0");
        checkOutPage.enterBillingCity("London");
        checkOutPage.enterBillingAddress("4,Down Street");
        checkOutPage.enterBillingZipcode("W4 2AB");
        checkOutPage.enterBillingPhoneNumber("4567395116994");
        ...
        checkOutPage3.enterCardHolderName("Rashi Vegad");
        checkOutPage3.enterCardNumber("2345789645678765");
