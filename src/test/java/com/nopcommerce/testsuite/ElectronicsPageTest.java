...
public class ElectronicsPageTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.enterFirstName("Jaymag");
        registerPage.enterLastName("parmar");
        registerPage.email("Jayst@gmail.com");
        registerPage.enterPassword("jesal12");
        registerPage.enterConfirmPassword("Jesal12");
        ...
        billingCheckOutPage.enterBillingAddress("4,BondStreet");
        billingCheckOutPage.enterBillingZipcode("W2 5RT");
        billingCheckOutPage.enterBillingPhoneNumber("9807652255");
        ...
        paymentCheckOutPage.enterCardNumber("4563432509876789");
